...
namespace afo_gui {
    ...
    void QNode::init_nh(){
        ...
        afo_gui_flat_time_pub = nh->advertise<std_msgs::Float32MultiArray>("/afo_gui/flat_time", 100);
    ...
    void QNode::pubFlatTime(float p, float d){
        std_msgs::Float32MultiArray m;
        m.data.push_back(p);
        m.data.push_back(d);
        afo_gui_flat_time_pub.publish(m);
